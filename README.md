...
|---|---|--:|---|
| ~~**Plus/4**~~ | TED text, 40×25 | **25** | NOTES item 57's 40×25 family — **released v0.20.0 at exactly this geometry** |
| ~~**MSX2**~~ | **V9938 SCREEN 7 bitmap, 512×212, 6×8 cells → 80×25** | **25** | **the CoCo 3 card port already does exactly this** on the sibling V9958: `coco3vid.c` — *"512 and 8-pixel rows give 26; the console takes 80×25"*, `MARGIN_Y 6` centring 200 lines in 212 — **released v0.22.0 exactly so**: SCREEN 7, 6×8 cells, `MARGIN_Y 6` |
...
| ~~**Apple IIgs**~~ | SHR 320×200, 8×8 cells | **25** | 200 ÷ 8 — **released v0.19.0 at exactly this geometry** |
