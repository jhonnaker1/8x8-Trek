...
def main():
    ...
    with open(HDR[:-2] + ".c", "w") as f:
        f.write("/* GENERATED by tools/gen_strings.py -- do not edit. */\n")
        f.write('#include "strdata.h"\n\n')
        f.write("const unsigned int str_offset[STR_COUNT] = {\n")
        for o in offsets:
            f.write("    %5d,\n" % o)
        f.write("};\n")
    ...
    print("gen_strings: rewrote %d call sites; index costs %d bytes in the binary"
          % (changed, len(ids) * 2))
